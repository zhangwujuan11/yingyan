(function (global, factory) {
    ...
    (global = global || self, global.HlsVodMobilePlayer = factory(global.Player));
    ...
    var AMFParser = function () {
      function AMFParser() {
        _classCallCheck$t(this, AMFParser);

        this.offset = 0;
        this.readOffset = this.offset;
      }

      _createClass$t(AMFParser, [{
        key: 'resolve',
    ...
    var FlvDemuxer = function () {
      function FlvDemuxer() {
        _classCallCheck$u(this, FlvDemuxer);
    ...
    var TsDemuxer = function () {
      function TsDemuxer(configs) {
        _classCallCheck$v(this, TsDemuxer);
      ...
      _createClass$v(TsDemuxer, [{
        ...
        value: function demux(frag) {
          ...
          while (buffer.length >= 188) {
            if (buffer.length >= 1 && buffer.array[0][buffer.offset] !== 71) {
              this.emit(DEMUX_EVENTS$2.DEMUX_ERROR, this.TAG, new Error('Untrust sync code: ' + buffer.array[0][buffer.offset] + ', try to recover;'), false);
            }
          ...
          setTimeout(function () {
            _this.emit(DEMUX_EVENTS$2.DEMUX_COMPLETE);
            // return;
        ...
        value: function pushVideoSample(pes, options) {
          var nals = NalUnit$2.getNalunits(pes.ES.buffer);
          var track = void 0;
          ...
          if (sps && pps) {
            meta.avcc = NalUnit$2.getAvcc(sps.body, pps.body);
            var metaEqual = TsDemuxer.compaireMeta(track.meta, meta, true);
        ...
        value: function pushVideoSampleHEVC(pes, options) {
          var nals = NalUnitHEVC$2.getNalunits(pes.ES.buffer);
          var track = void 0;
          var meta = new VideoTrackMeta$1();
          meta.streamType = 0x24;
    ...
    var M3U8Parser = function () {
      function M3U8Parser() {
        _classCallCheck$w(this, M3U8Parser);
      }

      _createClass$w(M3U8Parser, null, [{
        key: 'parse',
    ...
    var Buffer$1 = function () {
      function Buffer(buffer) {
        _classCallCheck$x(this, Buffer);

        this.buffer = buffer || new Uint8Array(0);
      }

      _createClass$x(Buffer, [{
        key: 'write',
    ...
    var Fmp4 = function () {
      function Fmp4() {
        _classCallCheck$y(this, Fmp4);
      }

      _createClass$y(Fmp4, null, [{
        key: 'size',
    ...
    var Mp4Remuxer = function () {
      function Mp4Remuxer() {
        ...
        _classCallCheck$z(this, Mp4Remuxer);
    ...
    var HlsVodMobileController = function () {
      function HlsVodMobileController(configs) {
        _classCallCheck$A(this, HlsVodMobileController);
      ...
      _createClass$A(HlsVodMobileController, [{
        key: 'init',
        value: function init() {
          // 初始化Buffer （M3U8/TS/Playlist);
          this._context.registry('M3U8_BUFFER', Buffer);
          this._tsBuffer = this._context.registry('TS_BUFFER', Buffer)();
          this._tracks = this._context.registry('TRACKS', Tracks$1)();

          this._playlist = this._context.registry('PLAYLIST', Playlist$1)({ autoclear: true });
        ...
        value: function _onLoaderCompete(buffer) {
          if (buffer.TAG === 'M3U8_BUFFER') {
            ...
            try {
              var mdata = M3U8Parser$1.parse(this.m3u8Text, this.baseurl);
            ...
            if (this._playlist.encrypt && this._playlist.encrypt.uri && !this._playlist.encrypt.key) {
              this._context.registry('DECRYPT_BUFFER', Buffer)();
              this._context.registry('KEY_BUFFER', Buffer)();
        ...
        key: 'load',
        value: function load(url) {
          this.baseurl = M3U8Parser$1.parseURL(url);
          this.url = url;
    ...
    var HlsVodMobilePlayer = function (_BasePlugin) {
      _inherits$2(HlsVodMobilePlayer, _BasePlugin);

      _createClass$B(HlsVodMobilePlayer, null, [{
        key: 'pluginName',
        get: function get() {
          return 'hlsVod';
        }
      ...
      function HlsVodMobilePlayer(options) {
        _classCallCheck$B(this, HlsVodMobilePlayer);

        var _this = _possibleConstructorReturn$2(this, (HlsVodMobilePlayer.__proto__ || Object.getPrototypeOf(HlsVodMobilePlayer)).call(this, options));
      ...
      _createClass$B(HlsVodMobilePlayer, [{
        ...
        value: function handleDefinitionChange(change) {
          var to = change.to;
        ...
        value: function _handleSetCurrentTime() {
          var time = parseFloat(this.player.video.currentTime);
          if (this._context) {
            this.hls.seek(time);
          }
        }
        ...
        value: function play() {
          ...
          return this.player.play().catch(function (e) {
            if (e && e.code === 20) {
              ...
              _this2.player.once('canplay', function () {
                _this2.player.play();
              });
            }
          });
        ...
        value: function __initEvents() {
          ...
          this.hls.on(MSE_EVENTS$2.SOURCE_UPDATE_END, function () {
        ...
        value: function initHlsBackupEvents(hls, ctx) {
          ...
          hls.once(EVENTS.REMUX_EVENTS.MEDIA_SEGMENT, function () {
            _this4.hls = hls;
            _this4.hls.mse.cleanBuffers().then(function () {
              _this4.hls.mse.resetContext(ctx);
              _this4.hls.mse.doAppend();
        ...
        value: function swithURL(url) {
          this.config.url = url;
          var context = new Context$1(HlsAllowedEvents$1);
          var hls = context.registry('HLS_VOD_CONTROLLER', HlsVodMobileController)({
            player: this,
