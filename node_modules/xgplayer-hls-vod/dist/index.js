(function (global, factory) {
  ...
  var RemuxedBuffer = function RemuxedBuffer() {
    _classCallCheck$1(this, RemuxedBuffer);
  ...
  var RemuxedBufferManager = function () {
    function RemuxedBufferManager() {
      _classCallCheck$1(this, RemuxedBufferManager);
    ...
    _createClass$1(RemuxedBufferManager, [{
      key: 'getSource',
  ...
  var XGDataView = function () {
    function XGDataView(buffer) {
      _classCallCheck$2(this, XGDataView);
  ...
  var AudioSample = function () {
    function AudioSample(info) {
      _classCallCheck$6(this, AudioSample);
    ...
    _createClass$6(AudioSample, null, [{
      key: "getDefault",
  ...
  var VideoSample = function () {
    ...
    function VideoSample(info) {
      _classCallCheck$6(this, VideoSample);
    ...
    _createClass$6(VideoSample, null, [{
      key: "getDefault",
      value: function getDefault() {
        return {
          dts: -1,
  ...
  var Context = function () {
    ...
    function Context(player, configs) {
      ...
      _classCallCheck$9(this, Context);
      ...
      value: function registry(tag, cls) {
        ...
        var enhanced = function (_cls) {
          ...
          function enhanced(a, b, c) {
            _classCallCheck$9(this, enhanced);
  ...
  var CRYPTO_EVENTS$1 = _EVENTS.CRYPTO_EVENTS;

  var Crypto = function () {
    function Crypto(config) {
      _classCallCheck$a(this, Crypto);
  ...
  var Compatibility = function () {
    ...
    _createClass$r(Compatibility, [{
      ...
      value: function doFixVideo(first, streamChangeStart) {
        ...
        if (this._videoLargeGap !== 0) {
          ...
          if (this._videoLargeGap !== this.preVideoGap) {
            ...
            this.emit(REMUX_EVENTS$1.DETECT_CHANGE_STREAM_DISCONTINUE, 'video', { prevDts: this.videoLastSample && this.videoLastSample.originDts, curDts: firstSample.originDts });
          }
        }
      ...
      value: function doFixAudio(first, streamChangeStart) {
        ...
        if (this._audioLargeGap !== 0) {
          ...
          if (this._audioLargeGap !== this.preAudioGap) {
            ...
            this.emit(REMUX_EVENTS$1.DETECT_CHANGE_STREAM_DISCONTINUE, 'audio', { prevDts: this.lastAudioOriginDts, curDts: _firstSample.originDts });
          }
      ...
      value: function fixChangeStreamVideo(changeIdx) {
        ...
        this.emit(REMUX_EVENTS$1.DETECT_CHANGE_STREAM_DISCONTINUE, 'video', { prevDts: prevDts, curDts: curDts });
      ...
      value: function fixChangeStreamAudio(changeIdx) {
        ...
        this.emit(REMUX_EVENTS$1.DETECT_CHANGE_STREAM_DISCONTINUE, 'audio', { prevDts: prevDts, curDts: curDts });
        this._audioLargeGap = 0;
  ...
  var TsDemuxer = function (_EventEmitter) {
    ...
    function TsDemuxer(_ref) {
      ...
      _classCallCheck$s(this, TsDemuxer);
  ...
  var TsDemuxer$1 = function () {
    function TsDemuxer$1(configs) {
      _classCallCheck$t(this, TsDemuxer$1);

      this.configs = Object.assign({}, configs);
      this.demuxer = null;
    }

    _createClass$t(TsDemuxer$1, [{
      key: 'init',
      value: function init() {
      ...
      value: function initDemuxer() {
        ...
        this.demuxer.on(TsDemuxer.EVENTS.SEI_PARSED, this.emit.bind(this, DEMUX_EVENTS$1.SEI_PARSED));
      }
      ...
      value: function demux(frag, isVod) {
        ...
        try {
          ...
          this.emit(DEMUX_EVENTS$1.DEMUX_ERROR, this.TAG, e, false);
        }
        ...
        this.emit(DEMUX_EVENTS$1.DEMUX_COMPLETE, hasVideo, hasAudio);
      }
    }, {
      ...
      value: function onMetaDataParsed(type, meta) {
        ...
        track.meta = meta;
        this.emit(DEMUX_EVENTS$1.METADATA_PARSED, type, meta);
      }
    }, {
      key: 'onVideoSampleParsed',
      value: function onVideoSampleParsed(sample) {
        if (sample.isKeyframe) {
          this.emit(DEMUX_EVENTS$1.ISKEYFRAME, sample.pts);
        }
  ...
  var M3U8Parser = function () {
    function M3U8Parser() {
      _classCallCheck$u(this, M3U8Parser);
    }

    _createClass$u(M3U8Parser, null, [{
      key: 'parse',
  ...
  var Buffer = function () {
    function Buffer(buffer) {
      _classCallCheck$v(this, Buffer);

      this.buffer = buffer || new Uint8Array(0);
    }

    _createClass$v(Buffer, [{
      key: 'write',
  ...
  var Fmp4 = function () {
    function Fmp4() {
      _classCallCheck$w(this, Fmp4);
    }

    _createClass$w(Fmp4, null, [{
      key: 'size',
  ...
  var Mp4Remuxer = function (_EventEmitter) {
    ...
    function Mp4Remuxer(_ref) {
      ...
      _classCallCheck$x(this, Mp4Remuxer);
  ...
  var Mp4Remuxer$1 = function () {
    function Mp4Remuxer$1() {
      ...
      _classCallCheck$y(this, Mp4Remuxer$1);
  ...
  var TsDemuxer$2 = TsDemuxer$1;
  var M3U8Parser$1 = M3U8Parser;
  var Mp4Remuxer$2 = Mp4Remuxer$1;
  ...
  var HlsVodController = function () {
    function HlsVodController(configs) {
      _classCallCheck$z(this, HlsVodController);
    ...
    _createClass$z(HlsVodController, [{
      key: 'init',
      value: function init() {
        ...
        this._compat = this._context.registry('COMPATIBILITY', CompatHls)();
        ...
        // 初始化TS Demuxer
        this._demuxer = this._context.registry('TS_DEMUXER', TsDemuxer$2)({ inputbuffer: 'TS_BUFFER' });

        // 初始化MP4 Remuxer
        this._context.registry('MP4_REMUXER', Mp4Remuxer$2)(this._player.currentTime);
      ...
      value: function initEvents() {
        ...
        this.on(LOADER_EVENTS$2.LOADER_COMPLETE, this._onLoaderCompete);

        this.on(LOADER_EVENTS$2.LOADER_ERROR, this._onLoadError);

        this.on(REMUX_EVENTS$3.INIT_SEGMENT, this._onInitSegment);

        this.on(DEMUX_EVENTS$2.SEI_PARSED, this._handleSEIParsed);

        this.on(REMUX_EVENTS$3.MEDIA_SEGMENT, this._onMediaSegment);

        this.on(DEMUX_EVENTS$2.METADATA_PARSED, this._onMetadataParsed);

        this.on(DEMUX_EVENTS$2.DEMUX_COMPLETE, this._onDemuxComplete);

        this.on(DEMUX_EVENTS$2.DEMUX_ERROR, this._onDemuxError);

        this.on(REMUX_EVENTS$3.REMUX_ERROR, this._onRemuxError);
        this.on(MSE_EVENTS$2.MSE_ERROR, this._handleMseError);
        this.on(MSE_EVENTS$2.SOURCE_UPDATE_END, this._onUpdateEnd);

        this.on('TIME_UPDATE', this._onTimeUpdate);

        this.on(MSE_EVENTS$2.SOURCE_UPDATE_END, this._onTimeUpdate);
      ...
      value: function _onDemuxComplete() {
        this.emit(REMUX_EVENTS$3.REMUX_MEDIA, 'ts');
      }
    }, {
      ...
      value: function load(url) {
        this.url = url;
        this.emitTo('M3U8_LOADER', LOADER_EVENTS$2.LADER_START, url, null, 0);
      }
    }, {
      key: '_preload',
      ...
      value: function destory() {
        ...
        this.off(LOADER_EVENTS$2.LOADER_ERROR, this._onLoadError);
  ...
  var HlsVodPlayer = function (_Player) {
    ...
    function HlsVodPlayer(options) {
      _classCallCheck$A(this, HlsVodPlayer);
      ...
      _this._handleSetCurrentTime = debounce$1(_this._handleSetCurrentTime.bind(_this), 200);
      _this.onWaiting = _this.onWaiting.bind(_this);
      // this.started = false;
      return _this;
    }

    _createClass$A(HlsVodPlayer, [{
      ...
      value: function replay() {
        ...
        this.__core__.mse.cleanBuffers().then(function () {
          ...
          _get$1(HlsVodPlayer.prototype.__proto__ || Object.getPrototypeOf(HlsVodPlayer.prototype), 'replay', _this3).call(_this3);
        });
      }
    }, {
      key: '_initEvents',
      value: function _initEvents() {
        ...
        this.__core__.once(REMUX_EVENTS$4.INIT_SEGMENT, function () {
          ...
          _get$1(HlsVodPlayer.prototype.__proto__ || Object.getPrototypeOf(HlsVodPlayer.prototype), 'start', _this4).call(_this4, mse.url);
        });
      ...
      value: function initHlsBackupEvents(hls, ctx) {
        ...
        hls.once(REMUX_EVENTS$4.INIT_SEGMENT, function () {
          if (!_this5.video.src) {
            console.log('挂载 src blob');
            var mse = hls.mse;
            _get$1(HlsVodPlayer.prototype.__proto__ || Object.getPrototypeOf(HlsVodPlayer.prototype), 'start', _this5).call(_this5, mse.url);
          }
        });
      ...
      value: function start() {
        ...
        if (!this._context) {
          this._context = new Context$1(this, this.hlsOps, HlsAllowedEvents$1);
        }
      ...
      value: function switchURL(url) {
        this.config.url = url;
        var context = new Context$1(this, this.hlsOps, HlsAllowedEvents$1);
        ...
        return new Promise(function (resolve) {
          if (_this6.__core__ && _this6.__core__.mse) {
            _this6.__core__.mse.destroy().then(function () {
              ...
              _get$1(HlsVodPlayer.prototype.__proto__ || Object.getPrototypeOf(HlsVodPlayer.prototype), 'destroy', _this6).call(_this6);
              resolve();
            });
            setTimeout(function () {
              resolve();
      ...
      key: 'currentTime',
      get: function get() {
        return _get$1(HlsVodPlayer.prototype.__proto__ || Object.getPrototypeOf(HlsVodPlayer.prototype), 'currentTime', this);
      },
